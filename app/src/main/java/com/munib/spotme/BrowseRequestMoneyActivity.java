...
public class BrowseRequestMoneyActivity extends BaseActivity {

    EditText interest_rate,amount,edtRequestMsg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_browse_request_money);
        ...
        proposed_payment_card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LayoutInflater factory = LayoutInflater.from(BrowseRequestMoneyActivity.this);
                final View deleteDialogView = factory.inflate(R.layout.dialog_proposed_payments, null);
                BottomSheetDialog deleteDialog = new BottomSheetDialog(BrowseRequestMoneyActivity.this,R.style.BottomSheetDialog);
                ...
                rv1.setLayoutManager(new LinearLayoutManager(BrowseRequestMoneyActivity.this));
                ...
                ProposedMoneyAdapter adapter1=new ProposedMoneyAdapter(BrowseRequestMoneyActivity.this,proposedMoneyArrayList);
        ...
        edtRequestMsg=(EditText) findViewById(R.id.edtRequestMsg);
        ...
        lend_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(edtRequestMsg.getText().toString().equals(""))
                {
                    edtRequestMsg.setError("Please enter the request message");
                ...
                }else if(interest_rate.getText().toString().equals(""))
                {
                    ...
                    url=
                            "<p><strong>SPOTME LOAN AGREEMENT</strong></p>\n" +
                                    ...
                                    +"<div class='parent'>\n\n\n" +
                                    "  <div style='display:inline-block'><center><img src='{IMAGE_PLACEHOLDER}'></br><u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LENDER_NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></center></div>\n" +
                            ...
                            new Timer().schedule(new TimerTask() {
                                ...
                                public void run() {
                                    ...
                                    for(int i=0;i<proposedMoneyArrayList.size();i++)
                                    {
                                        ...
                                        database.getReference("payments").child(currentUserData.getUid()+"_"+timez).child(model.getIndex()+"").setValue(model);
                                    }

                                    OffersModel userModel=new OffersModel("borrow",amount.getText().toString(),amountAfterLoan_value+"",interest_rate.getText().toString(),duration.getSelectedItem().toString(),0,new Date().getTime()+"",false,true,url,"",currentUserData.getUid());
                                    userModel.setRequest_message(edtRequestMsg.getText().toString());
                                    database.getReference("universal_requests").child(currentUserData.getUid()+"_"+ timez).setValue(userModel);
                                    runOnUiThread(new Runnable() {
                                        public void run() {
//                                            if(selected_user_token!=null) {
//                                                sendNotification(currentUserData.getName() + " has sent you an request to borrow $" + amount.getText().toString(), selected_user_token);
//                                                database.getReference("notifications").child(selectedUser.getUid()).push().child("notification").setValue(currentUserData.getName() + " has sent you an request to borrow $" + amount.getText().toString());
//
//                                            }
                                            Toast.makeText(BrowseRequestMoneyActivity.this,"Your request has been submitted for approval, this may up to 24 hours to process",Toast.LENGTH_LONG).show();
                                            hideProgress();
                                        }
                                    });
