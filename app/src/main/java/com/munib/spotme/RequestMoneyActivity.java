...
public class RequestMoneyActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        amountAfterLoan=(TextView) findViewById(R.id.amountAfterLoan);
        ...
        proposed_payment_card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LayoutInflater factory = LayoutInflater.from(RequestMoneyActivity.this);
                final View deleteDialogView = factory.inflate(R.layout.dialog_proposed_payments, null);
                BottomSheetDialog deleteDialog = new BottomSheetDialog(RequestMoneyActivity.this,R.style.BottomSheetDialog);
                ...
                rv1.setLayoutManager(new LinearLayoutManager(RequestMoneyActivity.this));
                ...
                ProposedMoneyAdapter adapter1=new ProposedMoneyAdapter(RequestMoneyActivity.this,proposedMoneyArrayList);
                        ...
                        public void onClick(View view) {
                            ...
                            new Timer().schedule(new TimerTask() {
                                ...
                                public void run() {
                                    ...
                                    OffersModel userModel=new OffersModel("borrow",amount.getText().toString(),amountAfterLoan_value+"",interest_rate.getText().toString(),duration.getSelectedItem().toString(),0,new Date().getTime()+"",false,true,url,selectedUser.getUid(),currentUserData.getUid());
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            ...
                                            Toast.makeText(RequestMoneyActivity.this,"Request Sent Successfully!",Toast.LENGTH_LONG).show();
                                            hideProgress();
                                        }
                                    });
...
//                    startActivity(a);
        ...
        rv.addOnItemTouchListener(
                new RecyclerItemClickListener(RequestMoneyActivity.this, rv ,new RecyclerItemClickListener.OnItemClickListener() {
