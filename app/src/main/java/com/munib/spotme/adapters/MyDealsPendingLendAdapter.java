...
public class MyDealsPendingLendAdapter extends RecyclerView.Adapter<MyDealsPendingLendAdapter.RestaurantViewHolder>{
    ...
    public MyDealsPendingLendAdapter(Context context, ArrayList<OffersModel> dataModels) {
        mContext = context;
    ...
    @Override
    public MyDealsPendingLendAdapter.RestaurantViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_item_pending_lended, parent, false);
        RestaurantViewHolder viewHolder = new RestaurantViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(MyDealsPendingLendAdapter.RestaurantViewHolder holder, int position) {
    ...
    public class RestaurantViewHolder extends RecyclerView.ViewHolder {
        TextView username;
        TextView price,duration,payment_plan,interest_rate,type,status_msg;
        CircleImageView image;
        TextView deceline_btn,payments_btn,pay_btn;
                    ...
                    decline.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if(selected_user_token!=null) {
                                ...
                                FirebaseDatabase.getInstance().getReference("notifications").child(restaurant.getBorrower()).push().child("notification").setValue(((MainActivity) mContext).currentUserData.getName() + "  has withdrawn the offer of $"+restaurant.getAmountAfterInterest());
                            }
