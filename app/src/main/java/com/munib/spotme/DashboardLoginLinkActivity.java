...
public class DashboardLoginLinkActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                {
                    DashboardLoginLinkActivity.this.finish();
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                webView.loadUrl("javascript:(function() { " +
                        "document.getElementById('manage-team').remove();"+
                        "document.getElementsByClassName('ContentListItem-container Box-root Box-background--white Box-divider--light-bottom-1 Flex-flex Flex-direction--row')[0].remove();"+
                        "})()");
                hideProgress();
            }
        ...
        getLoginLink(auth.getCurrentUser().getUid());
    }
    ...
    public void getAccountLink(String uid)
    {
        showProgress();
        try {
            RequestQueue requestQueue = Volley.newRequestQueue(DashboardLoginLinkActivity.this);
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    hideProgress();
                    finish();
                    Toast.makeText(DashboardLoginLinkActivity.this,"Technical Issue ! Please try again in few momments",Toast.LENGTH_LONG).show();
                }
            }) {
                @Override
        ...
        try {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    hideProgress();
                    finish();
                    Toast.makeText(DashboardLoginLinkActivity.this,"Please complete on-boarding to access payouts dashboard",Toast.LENGTH_LONG).show();
